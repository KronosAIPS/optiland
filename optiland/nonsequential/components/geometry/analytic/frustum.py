...
class CylindricalFrustumGeometry(AnalyticGeometry):
    ...
    def ray_intersect(
        ...
        # scale rather than a bare 1e-14 (docs/theory/08_precision.md sec
        # 8.7). b_small uses the same scale so the two thresholds agree.
        ...
        # (docs/theory/08_precision.md sec 8.8). The additive-epsilon form
        # this replaced, "1.0 / (2.0 * a + 1e-30)", is the exact NaN source
        # measured in NS2_precision_and_torch_measurements.md section 9: its
