...
class AnnularPlaneGeometry(AnalyticGeometry):
    ...
    def ray_intersect(
        ...
        # is O(1)), not a bare 1e-12/1e-9 -- see docs/theory/08_precision.md
        # sec 8.7. Denominator guard is sqrt(smallest normal) of the working
        # dtype, not a bare 1e-30 -- sec 8.8.
